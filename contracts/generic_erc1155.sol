...
abstract contract IERC1155Receiver {
    ...
    function onERC1155BatchReceived(address _operator, address _from, uint256[] calldata _ids, uint256[] calldata _values, bytes calldata _data) external virtual returns(bytes4);
}
...
contract GenericERC1155NFT is TokenAccessControl, ERC1155TokenReceiver {
    ...
    bytes4 constant private InterfaceSignature_ERC1155 = 0xd9b67a26;
    ...
    function supportsInterface(bytes4 _interfaceID) external pure returns (bool) {
        return ((_interfaceID == InterfaceSignature_ERC165) ||
                (_interfaceID == InterfaceSignature_ERC1155));
    }
